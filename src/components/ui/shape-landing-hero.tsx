...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-start pt-10 md:items-center md:pt-16 justify-center overflow-hidden bg-background">
      {/* Gradient overlay */}
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted/50 border border-border mb-4 md:mb-8"
          >
            <Circle className="h-2 w-2 fill-primary text-primary" />
            <span className="text-xs sm:text-sm tracking-wide text-muted-foreground">
              {badge}
            </span>
          </motion.div>
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mt-6 md:mt-8 max-w-2xl mx-auto">
              {description ||
